      ...
      <main className="flex-1">
        ...
        <section className="relative px-4 sm:px-6 py-20 md:py-32 text-center max-w-5xl mx-auto flex flex-col items-center justify-center min-h-[90vh]">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full px-4 sm:px-0">
              ...
              <Link to="/login" className="w-full sm:w-auto px-8 py-4 text-base font-medium text-gray-700 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-all flex items-center justify-center gap-2">
                Log in
              </Link>
            </div>
          </motion.div>
        ...
        <section className="bg-slate-900 text-white py-20 md:py-32 px-4 sm:px-6 relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            >
              {[
                { step: "01", title: "Create an Account", desc: "Click 'Get Started' to join LUMERAY. New users start with a clean slate of $0 expenses." },
